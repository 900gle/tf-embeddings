...
def query_a(keyword):
    ...
    url_api = "http://localhost:8080/api/search/location?countryCode="+keyword
...
def cache_monitoring():
    ...
    node = data["nodes"]["CbLlYTbfSkukgi6pT1iMAw"]["indices"]
...
if __name__ == '__main__':
    ...
    COUNTRY_FILE = "../cache_test/query/country.csv"
    SIZE = 300
